...
int main(int argc, char* argv[]){
	...
	double startTime, endTime;
		...
		if (rank == MASTER){		
			...
			// Create window
			window = SDL_CreateWindow( "Práctica 3 de PSD",0, 0,worldWidth * CELL_SIZE, worldHeight * CELL_SIZE,SDL_WINDOW_SHOWN);			
			...
			masterLogic(window, renderer, worldWidth, worldHeight, totalIterations, autoMode, outputFile, distModeStatic, grainSize, size);
